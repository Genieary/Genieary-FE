...
const DiaryDetailPage: React.FC<DiaryDetailPageProps> = ({ selectedDate, onBack }) => {
  ...
  // 일기 로드 + 편집모드 초기화
  useEffect(() => {
    const content = getDiary(key)?.content ?? '';
    setDiaryContent(content);
    setIsEditing(content.trim().length === 0);
  }, [key, getDiary]);
...
<path d="M20.25 22.5L28.875 31.125L26.25 33.75L15 22.5L26.25 11.25L28.875 13.875L20.25 22.5Z" fill="#1D1B20"/>
          ...
          <HeaderRight>
            <ShareButton onClick={handleShare}><svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3.33301 9V15C3.33301 15.3978 3.5086 15.7794 3.82116 16.0607C4.13372 16.342 4.55765 16.5 4.99967 16.5H14.9997C15.4417 16.5 15.8656 16.342 16.1782 16.0607C16.4907 15.7794 16.6663 15.3978 16.6663 15V9M13.333 4.5L9.99967 1.5M9.99967 1.5L6.66634 4.5M9.99967 1.5L9.99967 11.25" stroke="#1E1E1E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
             공유하기</ShareButton>
            <CameraButton onClick={() => setShowCamera(true)}><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_676_1504)">
              <path d="M19.1663 15.8333C19.1663 16.2754 18.9907 16.6993 18.6782 17.0118C18.3656 17.3244 17.9417 17.5 17.4997 17.5H2.49967C2.05765 17.5 1.63372 17.3244 1.32116 17.0118C1.0086 16.6993 0.833008 16.2754 0.833008 15.8333V6.66667C0.833008 6.22464 1.0086 5.80072 1.32116 5.48816C1.63372 5.17559 2.05765 5 2.49967 5H5.83301L7.49967 2.5H12.4997L14.1663 5H17.4997C17.9417 5 18.3656 5.17559 18.6782 5.48816C18.9907 5.80072 19.1663 6.22464 19.1663 6.66667V15.8333Z" stroke="#1E1E1E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M9.99967 14.1667C11.8406 14.1667 13.333 12.6743 13.333 10.8333C13.333 8.99238 11.8406 7.5 9.99967 7.5C8.15873 7.5 6.66634 8.99238 6.66634 10.8333C6.66634 12.6743 8.15873 14.1667 9.99967 14.1667Z" stroke="#1E1E1E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </g>
      <defs>
...
<g clip-path="url(#clip0_676_1407)">
<path d="M18.3337 1.66699L9.16699 10.8337M18.3337 1.66699L12.5003 18.3337L9.16699 10.8337M18.3337 1.66699L1.66699 7.50033L9.16699 10.8337" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</g>
<defs>
...
<path d="M10.0003 4.16699V15.8337M4.16699 10.0003H15.8337" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
일정 추가
            </PrimarySmall>
          </SectionTitleRow>
...
<path d="M20.0003 11.667L22.5753 16.8837L28.3337 17.7253L24.167 21.7837L25.1503 27.517L20.0003 24.8087L14.8503 27.517L15.8337 21.7837L11.667 17.7253L17.4253 16.8837L20.0003 11.667Z" fill="#FF993C" stroke="#FF993C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>:<svg width="40" height="39" viewBox="0 0 40 39" fill="none" xmlns="http://www.w3.org/2000/svg">
<ellipse cx="19.5455" cy="19.5" rx="19.5455" ry="19.5" fill="#FFF3BF"/>
<path d="M20.0003 11.667L22.5753 16.8837L28.3337 17.7253L24.167 21.7837L25.1503 27.517L20.0003 24.8087L14.8503 27.517L15.8337 21.7837L11.667 17.7253L17.4253 16.8837L20.0003 11.667Z" stroke="#FF993C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
